    ...
    return <Modal isOpen={isOpen} close={onCancel} classSize="w-full max-w-sm">
        ...
        <div class="row space-x-2">
            <button onClick={onCancel}
                className="w-full col text-center font-semibold py-2 px-4 border border-transparent shadow-sm rounded-md text-gray-700 bg-gray-300 hover:bg-gray-400 focus-ring">
                Cancel
            </button>
