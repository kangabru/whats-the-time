...
function App() {
    return <div class="flex flex-col h-full min-h-screen">
        ...
        <div class="row justify-end p-2">
            <a href="https://github.com/kangabru/whats-the-time/" class="row space-x-2 pl-3 pr-2 py-2 rounded-md focus-ring hover:bg-gray-200">
                <span>Star</span>
                <GitHubIcon />
            </a>
        </div>
